...
if __name__ == "__main__":
    ...
    while cap1.isOpened():
        ...
        if success1 and success2:
            ...
            m_left_center1 = mean_window(left_center1, 5)
            m_right_center1 = mean_window(right_center1, 5)
            left1 = drawImg(left_annotated_frame, left_mask, m_left_center1)
            right1 = drawImg(right_annotated_frame, right_mask, m_right_center1)

            ##
            left_center2 = compute_centroid_via_pixels_and_draw(left_mask)
            right_center2 = compute_centroid_via_pixels_and_draw(right_mask)
            m_left_center2 = mean_window(left_center2, 5)
            m_right_center2 = mean_window(right_center2, 5)
            left2 = drawImg(left_annotated_frame, left_mask, m_left_center2)
            right2 = drawImg(right_annotated_frame, right_mask, m_right_center2)

            ##
            left_center3 = compute_centroid_via_bbox_and_draw(left_mask)
            right_center3 = compute_centroid_via_bbox_and_draw(right_mask)
            m_left_center3 = mean_window(left_center3, 5)
            m_right_center3 = mean_window(right_center3, 5)
            left3 = drawImg(left_annotated_frame, left_mask, m_left_center3)
            right3 = drawImg(right_annotated_frame, right_mask, m_right_center3)

            ##
            left_center4 = find_centroids_with_stats_and_draw(left_mask)
            right_center4 = find_centroids_with_stats_and_draw(right_mask)
            m_left_center4 = mean_window(left_center4, 5)
            m_right_center4 = mean_window(right_center4, 5)
            left4 = drawImg(left_annotated_frame, left_mask, m_left_center4)
            right4 = drawImg(right_annotated_frame, right_mask, m_right_center4)
